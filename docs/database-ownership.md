...
- Main-database shadow tables remain for identity, media, progress, room, and timeline fallback. Later cleanup can remove them after sync confidence is high.
